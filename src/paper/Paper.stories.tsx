...
const Template: Story = () =>
    <div className="paper-story">
        <Paper showHoverEffect={true}>
            ...
            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent fringilla faucibus diam quis faucibus.
            ...
            <p> Duis faucibus nunc enim, ac facilisis ante dictum sed. Aliquam erat volutpat. Sed ligula est, tempor
                ...
                scelerisque. Praesent in vehicula arcu, et bibendum nibh. In laoreet erat eu tempor interdum.</p>
        </Paper>
    </div>;
